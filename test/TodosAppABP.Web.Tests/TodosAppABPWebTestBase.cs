...
{
    public abstract class TodosAppABPWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static TodosAppABPWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(TodosAppABPWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<TodosAppABPDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<TodosAppABPDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<TodosAppABPDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<TodosAppABPDbContext, Task<T>> func)
        {
            T result;
